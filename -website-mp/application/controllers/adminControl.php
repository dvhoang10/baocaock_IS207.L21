...
class adminControl extends BaseController
{
    ...
    public function getAllProduct()
    {
        ...
        foreach ($allProduct as $val) {
            ...
            $row[] = '<span class="p-short-discription text-wrap" id_p="' . $val->id . '">' . $val->short_discription . '</span>';
            $row[] = '<span class="p-discription text-wrap" id_p="' . $val->id . '">' . $val->discription . '</span><br>';
            $row[] = $val->date_created;
            $data[] = $row;
        }
